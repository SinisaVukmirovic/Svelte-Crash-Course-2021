...
var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "card svelte-1r66vcm");
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-1e2p6bh"));
    			add_location(button, file$6, 6, 0, 124);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*style*/ 1 && button_class_value !== (button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-1e2p6bh"))) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "svelte-1g0us09");
    			add_location(input0, file$5, 15, 6, 317);
    			attr_dev(label0, "for", "num1");
    			attr_dev(label0, "class", "svelte-1g0us09");
    			add_location(label0, file$5, 16, 6, 425);
    			attr_dev(li0, "class", "svelte-1g0us09");
    			add_location(li0, file$5, 14, 4, 305);
    			attr_dev(input1, "type", "radio");
    			attr_dev(input1, "id", "num2");
    			attr_dev(input1, "name", "rating");
    			input1.value = "2";
    			input1.checked = input1_checked_value = /*selected*/ ctx[0] === 2;
    			attr_dev(input1, "class", "svelte-1g0us09");
    			add_location(input1, file$5, 19, 6, 481);
    			attr_dev(label1, "for", "num2");
    			attr_dev(label1, "class", "svelte-1g0us09");
    			add_location(label1, file$5, 20, 6, 589);
    			attr_dev(li1, "class", "svelte-1g0us09");
    			add_location(li1, file$5, 18, 4, 469);
    			attr_dev(input2, "type", "radio");
    			attr_dev(input2, "id", "num3");
    			attr_dev(input2, "name", "rating");
    			input2.value = "3";
    			input2.checked = input2_checked_value = /*selected*/ ctx[0] === 3;
    			attr_dev(input2, "class", "svelte-1g0us09");
    			add_location(input2, file$5, 23, 6, 645);
    			attr_dev(label2, "for", "num3");
    			attr_dev(label2, "class", "svelte-1g0us09");
    			add_location(label2, file$5, 24, 6, 753);
    			attr_dev(li2, "class", "svelte-1g0us09");
    			add_location(li2, file$5, 22, 4, 633);
    			attr_dev(input3, "type", "radio");
    			attr_dev(input3, "id", "num4");
    			attr_dev(input3, "name", "rating");
    			input3.value = "4";
    			input3.checked = input3_checked_value = /*selected*/ ctx[0] === 4;
    			attr_dev(input3, "class", "svelte-1g0us09");
    			add_location(input3, file$5, 27, 6, 809);
    			attr_dev(label3, "for", "num4");
    			attr_dev(label3, "class", "svelte-1g0us09");
    			add_location(label3, file$5, 28, 6, 917);
    			attr_dev(li3, "class", "svelte-1g0us09");
    			add_location(li3, file$5, 26, 4, 797);
    			attr_dev(input4, "type", "radio");
    			attr_dev(input4, "id", "num5");
    			attr_dev(input4, "name", "rating");
    			input4.value = "5";
    			input4.checked = input4_checked_value = /*selected*/ ctx[0] === 5;
    			attr_dev(input4, "class", "svelte-1g0us09");
    			add_location(input4, file$5, 31, 6, 973);
    			attr_dev(label4, "for", "num5");
    			attr_dev(label4, "class", "svelte-1g0us09");
    			add_location(label4, file$5, 32, 6, 1081);
    			attr_dev(li4, "class", "svelte-1g0us09");
    			add_location(li4, file$5, 30, 4, 961);
    			attr_dev(input5, "type", "radio");
    			attr_dev(input5, "id", "num6");
    			attr_dev(input5, "name", "rating");
    			input5.value = "6";
    			input5.checked = input5_checked_value = /*selected*/ ctx[0] === 6;
    			attr_dev(input5, "class", "svelte-1g0us09");
    			add_location(input5, file$5, 35, 6, 1137);
    			attr_dev(label5, "for", "num6");
    			attr_dev(label5, "class", "svelte-1g0us09");
    			add_location(label5, file$5, 36, 6, 1245);
    			attr_dev(li5, "class", "svelte-1g0us09");
    			add_location(li5, file$5, 34, 4, 1125);
    			attr_dev(input6, "type", "radio");
    			attr_dev(input6, "id", "num7");
    			attr_dev(input6, "name", "rating");
    			input6.value = "7";
    			input6.checked = input6_checked_value = /*selected*/ ctx[0] === 7;
    			attr_dev(input6, "class", "svelte-1g0us09");
    			add_location(input6, file$5, 39, 6, 1301);
    			attr_dev(label6, "for", "num7");
    			attr_dev(label6, "class", "svelte-1g0us09");
    			add_location(label6, file$5, 40, 6, 1409);
    			attr_dev(li6, "class", "svelte-1g0us09");
    			add_location(li6, file$5, 38, 4, 1289);
    			...
    			attr_dev(input7, "class", "svelte-1g0us09");
    			add_location(input7, file$5, 43, 6, 1465);
    			attr_dev(label7, "for", "num8");
    			attr_dev(label7, "class", "svelte-1g0us09");
    			add_location(label7, file$5, 44, 6, 1573);
    			attr_dev(li7, "class", "svelte-1g0us09");
    			add_location(li7, file$5, 42, 4, 1453);
    			...
    			attr_dev(input8, "class", "svelte-1g0us09");
    			add_location(input8, file$5, 47, 6, 1629);
    			attr_dev(label8, "for", "num9");
    			attr_dev(label8, "class", "svelte-1g0us09");
    			add_location(label8, file$5, 48, 6, 1737);
    			attr_dev(li8, "class", "svelte-1g0us09");
    			add_location(li8, file$5, 46, 4, 1617);
    			...
    			attr_dev(input9, "class", "svelte-1g0us09");
    			add_location(input9, file$5, 51, 6, 1793);
    			attr_dev(label9, "for", "num10");
    			attr_dev(label9, "class", "svelte-1g0us09");
    			add_location(label9, file$5, 52, 6, 1904);
    			attr_dev(li9, "class", "svelte-1g0us09");
    			add_location(li9, file$5, 50, 4, 1781);
    			attr_dev(ul, "class", "rating svelte-1g0us09");
    			add_location(ul, file$5, 13, 0, 280);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (65:12) <Button disabled={btnDisabled} type="submit">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(65:12) <Button disabled={btnDisabled} type=\\\"submit\\\">",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "message svelte-1apnq5e");
    			add_location(div, file$4, 67, 10, 2029);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-1apnq5e");
    			add_location(h2, file$4, 58, 8, 1548);
    			attr_dev(header, "class", "svelte-1apnq5e");
    			add_location(header, file$4, 57, 4, 1530);
    			attr_dev(input, "id", "text-input");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Tell us something that keeps you coming back");
    			attr_dev(input, "class", "svelte-1apnq5e");
    			add_location(input, file$4, 63, 12, 1771);
    			attr_dev(div, "class", "input-group svelte-1apnq5e");
    			add_location(div, file$4, 62, 8, 1732);
    			add_location(form, file$4, 60, 4, 1618);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const handleInput = () => {
    		if (text.trim().length <= minChars) {
    			$$invalidate(2, message = `Text must be at least ${minChars} characters!`);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('minChars' in $$props) minChars = $$props.minChars;
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			t4 = text(t4_value);
    			attr_dev(div0, "class", "num-display svelte-14yw85a");
    			add_location(div0, file$3, 25, 4, 777);
    			attr_dev(button, "class", "close svelte-14yw85a");
    			add_location(button, file$3, 30, 4, 988);
    			attr_dev(div1, "class", "text-display");
    			add_location(div1, file$3, 31, 4, 1072);
    		},
    		m: function mount(target, anchor) {
    ...
    // (21:0) {#each $FeedbackStore as fb (fb.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$2, 21, 4, 750);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(21:0) {#each $FeedbackStore as fb (fb.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let t0;
    	let t1;
    	let t2_value = (/*count*/ ctx[0] === 1 ? 'rating!' : 'ratings!') + "";
    	let t2;
    	let t3;
    	let h41;
    	let t4;
    	let t5_value = /*average*/ ctx[1].toFixed(2) + "";
    	let t5;
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			h41 = element("h4");
    			t4 = text("Average ratings: ");
    			t5 = text(t5_value);
    			add_location(h40, file$1, 12, 4, 327);
    			add_location(h41, file$1, 13, 4, 388);
    			attr_dev(div, "class", "feedback-ratings svelte-16irpj3");
    			add_location(div, file$1, 11, 0, 291);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*count*/ 1 && t2_value !== (t2_value = (/*count*/ ctx[0] === 1 ? 'rating!' : 'ratings!') + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*average*/ 2 && t5_value !== (t5_value = /*average*/ ctx[1].toFixed(2) + "")) set_data_dev(t5, t5_value);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*$FeedbackStore, count*/ 5) {
    			$$invalidate(1, average = $FeedbackStore.reduce((a, { rating }) => a + rating, 0) / count);
    		}
    	};
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 53, 0, 1811);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
